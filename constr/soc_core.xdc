...
## Pmod Header JA
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { UART_MASTER_RX }]; #IO_L5N_T0_D07_14 Sch=ja[1]
set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS33 } [get_ports { UART_MASTER_TX }]; #IO_L4N_T0_D05_14 Sch=ja[2]
...
set_property PACKAGE_PIN M3  [get_ports {fcen_Sys0_S0[0]}]; #IO_L8N_T1_AD14N_35 Sch=pio[01]
#set_property PACKAGE_PIN L3  [get_ports {fd_Sys0_S0[3]}]; #IO_L8P_T1_AD14P_35 Sch=pio[02]
#set_property PACKAGE_PIN A16 [get_ports {fd_Sys0_S0[2]}]; #IO_L12P_T1_MRCC_16 Sch=pio[03]
#set_property PACKAGE_PIN K3  [get_ports {fd_Sys0_S0[1]}]; #IO_L7N_T1_AD6N_35 Sch=pio[04]
#set_property PACKAGE_PIN C15 [get_ports {fd_Sys0_S0[0]}]; #IO_L11P_T1_SRCC_16 Sch=pio[05]
set_property PACKAGE_PIN H1  [get_ports {fsclk_Sys0_S0[0]}]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
set_property PACKAGE_PIN A15 [get_ports {fd_Sys0_S0[3]}]; #IO_L6N_T0_VREF_16 Sch=pio[07]
set_property PACKAGE_PIN B15 [get_ports {fd_Sys0_S0[2]}]; #IO_L11N_T1_SRCC_16 Sch=pio[08]
set_property PACKAGE_PIN A14 [get_ports {fd_Sys0_S0[1]}]; #IO_L6P_T0_16 Sch=pio[09]
set_property PACKAGE_PIN J3  [get_ports {fd_Sys0_S0[0]}]; #IO_L7P_T1_AD6P_35 Sch=pio[10]
# set_property PACKAGE_PIN J1  [get_ports {GPIO_Sys0_S2[15]}]; #IO_L3N_T0_DQS_AD5N_35 Sch=pio[11]
...
set_property PACKAGE_PIN M1  [get_ports {GPIO_Sys0_S2[11]}]; #IO_L9N_T1_DQS_AD7N_35 Sch=pio[17]
set_property PACKAGE_PIN N3  [get_ports { GPIO_Sys0_S2[10] }]; #IO_L12P_T1_MRCC_35 Sch=pio[18]
set_property PACKAGE_PIN P3  [get_ports { GPIO_Sys0_S2[9] }]; #IO_L12N_T1_MRCC_35 Sch=pio[19]
set_property PACKAGE_PIN M2  [get_ports { GPIO_Sys0_S2[8] }]; #IO_L9P_T1_DQS_AD7P_35 Sch=pio[20]
...
set_property PACKAGE_PIN P1  [get_ports { GPIO_Sys0_S2[5] }]; #IO_L19N_T3_VREF_35 Sch=pio[23]
set_property PACKAGE_PIN R3  [get_ports { GPIO_Sys0_S2[4] }]; #IO_L2P_T0_34 Sch=pio[26]
...
# set_property PACKAGE_PIN W2 [get_ports { NMI }]; #IO_L5N_T0_34 Sch=pio[32]
 ...
 #set_property PACKAGE_PIN G17 [get_ports { UART_MASTER_RX }]; #IO_L3N_T0_DQS_34 Sch=pio[31]
 #set_property PACKAGE_PIN G19 [get_ports { UART_MASTER_TX }]; #IO_L5N_T0_34 Sch=pio[32]
...
set_property PACKAGE_PIN V4 [get_ports { MSO_Sys0_SS0_S2[0] }]; #IO_L11N_T1_SRCC_34 Sch=pio[37]
...
set_property PACKAGE_PIN W6 [get_ports { SCLK_Sys0_SS0_S2[0] }]; #IO_L13N_T2_MRCC_34 Sch=pio[43]
...
set_property PACKAGE_PIN W7 [get_ports { SSn_Sys0_SS0_S2[0] }]; #IO_L13P_T2_MRCC_34 Sch=pio[46]
set_property PACKAGE_PIN U8 [get_ports { sda_Sys0_SS0_S5[0] }]; #IO_L14P_T2_SRCC_34 Sch=pio[47]
set_property PACKAGE_PIN V8 [get_ports { SSn_Sys0_SS0_S3[0] }]; #IO_L14N_T2_SRCC_34 Sch=pio[48]


set_property IOSTANDARD LVCMOS33  [get_ports {fcen_Sys0_S0[0]}]; #IO_L8N_T1_AD14N_35 Sch=pio[01]
set_property IOSTANDARD LVCMOS33  [get_ports {fd_Sys0_S0[3]}]; #IO_L8P_T1_AD14P_35 Sch=pio[02]
set_property IOSTANDARD LVCMOS33 [get_ports {fd_Sys0_S0[2]}]; #IO_L12P_T1_MRCC_16 Sch=pio[03]
set_property IOSTANDARD LVCMOS33  [get_ports {fd_Sys0_S0[1]}]; #IO_L7N_T1_AD6N_35 Sch=pio[04]
set_property IOSTANDARD LVCMOS33 [get_ports {fd_Sys0_S0[0]}]; #IO_L11P_T1_SRCC_16 Sch=pio[05]
set_property IOSTANDARD LVCMOS33  [get_ports {fsclk_Sys0_S0[0]}]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
set_property IOSTANDARD LVCMOS33 [get_ports {fd_Sys0_S0[3]}]; #IO_L6N_T0_VREF_16 Sch=pio[07]
set_property IOSTANDARD LVCMOS33 [get_ports {fd_Sys0_S0[2]}]; #IO_L11N_T1_SRCC_16 Sch=pio[08]
set_property IOSTANDARD LVCMOS33 [get_ports {fd_Sys0_S0[1]}]; #IO_L6P_T0_16 Sch=pio[09]
set_property IOSTANDARD LVCMOS33  [get_ports {fd_Sys0_S0[0]}]; #IO_L7P_T1_AD6P_35 Sch=pio[10]
# set_property IOSTANDARD LVCMOS33  [get_ports {GPIO_Sys0_S2[15]}]; #IO_L3N_T0_DQS_AD5N_35 Sch=pio[11]
...
set_property IOSTANDARD LVCMOS33  [get_ports {GPIO_Sys0_S2[11]}]; #IO_L9N_T1_DQS_AD7N_35 Sch=pio[17]
set_property IOSTANDARD LVCMOS33  [get_ports { GPIO_Sys0_S2[10] }]; #IO_L12P_T1_MRCC_35 Sch=pio[18]
set_property IOSTANDARD LVCMOS33  [get_ports { GPIO_Sys0_S2[9] }]; #IO_L12N_T1_MRCC_35 Sch=pio[19]
set_property IOSTANDARD LVCMOS33  [get_ports { GPIO_Sys0_S2[8] }]; #IO_L9P_T1_DQS_AD7P_35 Sch=pio[20]
...
set_property IOSTANDARD LVCMOS33  [get_ports { GPIO_Sys0_S2[5] }]; #IO_L19N_T3_VREF_35 Sch=pio[23]
set_property IOSTANDARD LVCMOS33  [get_ports { GPIO_Sys0_S2[4] }]; #IO_L2P_T0_34 Sch=pio[26]
...
set_property IOSTANDARD LVCMOS33 [get_ports { MSO_Sys0_SS0_S2[0] }]; #IO_L11N_T1_SRCC_34 Sch=pio[37]
...
set_property IOSTANDARD LVCMOS33 [get_ports { SCLK_Sys0_SS0_S2[0] }]; #IO_L13N_T2_MRCC_34 Sch=pio[43]
...
set_property IOSTANDARD LVCMOS33 [get_ports { SSn_Sys0_SS0_S2[0] }]; #IO_L13P_T2_MRCC_34 Sch=pio[46]
set_property IOSTANDARD LVCMOS33 [get_ports { sda_Sys0_SS0_S5[0] }]; #IO_L14P_T2_SRCC_34 Sch=pio[47]
set_property IOSTANDARD LVCMOS33 [get_ports { SSn_Sys0_SS0_S3[0] }]; #IO_L14N_T2_SRCC_34 Sch=pio[48]

## UART
set_property PACKAGE_PIN J18 [get_ports { RsRx_Sys0_SS0_S0[0] }]; #IO_L7N_T1_D10_14 Sch=uart_rxd_out
set_property PACKAGE_PIN J17 [get_ports { RsTx_Sys0_SS0_S0[0] }]; #IO_L7P_T1_D09_14 Sch=uart_txd_in
